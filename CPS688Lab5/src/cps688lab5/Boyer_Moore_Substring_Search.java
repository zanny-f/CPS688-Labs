 ...
 */
package cps688lab5;import java.util.Scanner;
 ...
 * @author farza
 */
public class Boyer_Moore_Substring_Search {
    ...
    static void search(char txt[], char pat[]) {
        ...
        while (s <= (n - m)) {
            ...
            the above loop */
            if (j < 0) {
                System.out.println("Pattern " + patString +" occurs at index = " + s);
